...
const flowPrincipal = addKeyword(['hola', 'ole', 'alo','buenas']).addAnswer(
    [
    '👋Hola , gracias por comunicarte con Gestión vial ✨',    
